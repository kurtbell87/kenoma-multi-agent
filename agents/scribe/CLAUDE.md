...
5. React ✅ to the original message, then report: `@pi Paper updated — [what changed]. PDF at shared/paper/main.pdf`
...
- You can ask `@senior-researcher` or `@surveyor` for clarification on their deliverables.
- You can ask `@engineer` for data extraction or figure generation help.
- You can ask `@theorist` about proof statements for the paper.
